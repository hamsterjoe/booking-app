...
export function ProfileSelect({
  ...
  return (
    <div className="relative">
      ...
      {isOpen ? (
        <div className="absolute left-0 right-0 z-40 mt-3 overflow-hidden rounded-3xl border border-white/10 bg-slate-950/95 p-2 shadow-2xl shadow-black/50 backdrop-blur-2xl">
          <button
            type="button"
            onClick={() => {
              setSelectedValue("");
